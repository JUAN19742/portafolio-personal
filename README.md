...
curl -X POST http://localhost:5000/api/posts \
  ...
  -d '{"title":"Test Post","content":"Contenido de prueba..."}'
```
...
Este proyecto es parte de un proyecto académico para la PUCE.

## 🙏 Agradecimientos

- Profesores y tutores de la PUCE
- Comunidad de desarrolladores de JavaScript
- Documentación de MDN, React y Node.js

## 📝 Notas del Proyecto

Este portafolio cumple con todos los requisitos del proyecto:

**Frontend (20 pts + 8 pts bonus)**:
- ✅ React + Vite
- ✅ Tailwind CSS
- ✅ React Router
...
**Autenticación (10 pts + 3 pts bonus)**:
- ✅ Sistema de login para admin
- ✅ Rutas protegidas
- ✅ JWT implementado
- ✅ Hash de contraseñas con bcrypt

**Base de Datos (15 pts)**:
...
**Despliegue (10 pts)**:
- ✅ Instrucciones completas para Vercel/Render
- ✅ MongoDB Atlas

**Blog (20 pts)**:
- ✅ 2 posts existentes (migrados)
- ✅ 2 posts nuevos sobre backend (1000+ palabras cada uno)

**Total**: 108 puntos posibles
...
**Hecho con ❤️ por Juan Sebastián Rueda Vilatuña**
